			...
			<div class="card">
				<div class="card-header">
					...
					<div class="card-body p-t-0">
						<form action="perhitungan_sistem_output.php" method="post">
							<div class="row">
								<div class="col-6">
								...
								<div class="col-6">
									<div class="form-group p-b-10">	
										...
										<textarea name="jawaban" class="form-control" placeholder="Jawaban Siswa" required></textarea>
									</div>
								</div>
							</div>
							<div class="row float-r m-r-5">	
								<button type="submit" name="hitungSistem" class="btn btn-primary">Hitung</button>
							</div>		
						</form>							
