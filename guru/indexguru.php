...
<body style="min-width: 768px"> 
  <div class="page-wrapper chiller-theme toggled">
    ...
    <nav class="navbar bg-dark navbar-dark container-fluid shadow-top ht-50"></nav>
    ...
    <nav id="sidebar" class="sidebar-wrapper">
      ...
      <div class="sidebar-content">
        <div class="sidebar-brand">
          <a href="indexguru.php?page=home">Esai Online</a>
        ...
        <div class="sidebar-header">
          <div class="user-pic">
            <img class="img-responsive img-rounded" src="../img/guru/<?php echo get_foto_guru_from_id($id_user); ?>"
            alt="User picture">
          </div>
          <div class="user-info">
            <span class="user-name"><?php echo get_guru_from_id($id_user); ?></span>
        ...
        <div class="sidebar-menu">
          <ul>            
            ...
            <li>
              <a href="indexguru.php?page=home">
                <i class="fas fa-tachometer-alt"></i>
                <span>Dashboard</span>
              </a>
            </li>
            <li>
              <a href="indexguru.php?page=ujian">
                <i class="fa fa-file-text"></i>
                <span>Ujian</span>
              </a>            
            <li>
              <a href="indexguru.php?page=nilaisiswa">
      ...
      <div class="sidebar-footer">
        <a href="indexguru.php?page=editprofil" >
          <i class="fa fa-cog"></i>
        </a>
