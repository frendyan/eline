		...
		<nav id="sidebar" class="sidebar-wrapper">
			...
			<div class="sidebar-content">
				<div class="sidebar-brand">
					<a href="indexadmin.php?page=home">Esai Online</a>
				...
				<div class="sidebar-header">
					<div class="user-pic">
						<img class="img-responsive img-rounded" src="../img/admin/<?php echo get_foto_admin_from_id($id); ?>"
						alt="User picture">
					</div>
					<div class="user-info">
						<span class="user-name"><?php echo get_admin_from_id($id); ?></span>
				...
				<div class="sidebar-menu">
					<ul>            
						...
						<li>
							<a href="indexadmin.php?page=home">
								<i class="fas fa-tachometer-alt"></i>
								<span>Dashboard</span>
							</a>
						</li>
						<li>
							<a href="indexadmin.php?page=ujian">
							...
							<div class="sidebar-submenu">
								<ul>
									<li>
										<a href="indexadmin.php?page=admin">Admin</a>
									</li>
									<li>
										<a href="indexadmin.php?page=guru">Guru</a>
									</li>
									<li>
										<a href="indexadmin.php?page=siswa">Siswa</a>
									</li>									
								</ul>
							</div>
						</li>
						<li>
							<a href="indexadmin.php?page=kelas">
								<i class="fa fa-id-card"></i>
								<span>Daftar Kelas</span>
							</a>
						</li>
						<li>
							<a href="indexadmin.php?page=pelajaran">
			...
			<div class="sidebar-footer">
				<a href="indexadmin.php?page=editprofil" >
					<i class="fa fa-cog"></i>
				</a>
